...
srun python3 cluster_run_average.py --data_seed_start=${data_seed_start} --data_seed_end=${data_seed_end} --weight_multiplier=${weight_multiplier} --weight_decay=${weight_decay} --epochs=${epochs} --cluster_arg=1
