...
if __name__ == '__main__':
    ...
    parser.add_argument("--weight_decay", type=float, default=0.01)#2 for their plot
    parser.add_argument("--lr", type=float, default=1e-3)
    parser.add_argument("--initialization_scale", type=float, default=8.0)
    parser.add_argument("--download_directory", type=str, default="/Users/dmitrymanning-coe/Documents/Research/Grokking/ModAddition/large_files")
